...
Public Class frmMenu
    ...
    Private CurrentDatabaseName As String = "C:\db\TreeView.mdb"
    ...
    Private Sub CreateChildNodes(ByVal treeControl As TreeView, Optional ByVal parentNode As TreeNode = Nothing)
        ...
        If parentNode Is Nothing Then
            sSQL = "SELECT MenuName, MenuDesc, HasSubFolder, SubFolderPath From TreeViewMenu WHERE ParentMenu is NULL ORDER BY MenuOrder, HasSubFolder, MenuDesc"
        Else
            sSQL = "SELECT MenuName, MenuDesc, HasSubFolder, SubFolderPath From TreeviewMenu WHERE ParentMenu = '" & parentNode.Text & "' ORDER BY MenuOrder, HasSubFolder, MenuDesc"
        End If
    ...
    Private Sub SaveTree(ByVal nNode As TreeNode, ByVal iSortOrder As Integer, sDBName As String)
        ...
        If OpenConn(sDBName) Then
            ...
            If nNode Is Nothing Then
                cmd.CommandText = "DELETE FROM TreeViewMenu"
                cmd.ExecuteNonQuery()
                For Each nd In TreeView1.Nodes
                    sSQL = "INSERT INTO TreeViewMenu(MenuDesc, MenuName, ParentMenu, HasSubFolder, SubFolderPath, MenuOrder) VALUES('" & nd.Text & "','" & nd.Name & "'"
                    sSQL = sSQL & ",NULL,"
